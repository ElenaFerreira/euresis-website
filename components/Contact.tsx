  ...
  return (
    <section className="w-full bg-gray-50 py-16 md:py-24" id="contact">
      <div className="container mx-auto px-4">
        <SectionTitle className="text-center">Contactez-nous</SectionTitle>
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
          ...
          <form>
            ...
            <div className="mb-6">
              ...
              <select id="need" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
